...
/* harmony import */ var _utils_notice_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/notice.js */ "./src/script/utils/notice.js");
...
var isValidDate = function isValidDate(timestamp) {
  ...
  var minTimestamp = Object(_utils_date__WEBPACK_IMPORTED_MODULE_1__["ceil15Minutes"])(nowTimestamp);
  return timestamp >= minTimestamp && Object(_utils_date__WEBPACK_IMPORTED_MODULE_1__["is15MinutesStep"])(timestamp);
};
...
var buildValidDate = function buildValidDate(timestamp) {
  ...
  var minTimestamp = Object(_utils_date__WEBPACK_IMPORTED_MODULE_1__["ceil15Minutes"])(nowTimestamp); // minimum schedule timestamp is next round 15 minutes

  if (timestamp < minTimestamp) return new Date(minTimestamp); // else round to nearest 15 minutes step

  return new Date(Object(_utils_date__WEBPACK_IMPORTED_MODULE_1__["round15Minutes"])(timestamp));
}; // --------------------------------------------
...
Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_0__["subscribe"])(function () {
  ...
  Object(_utils_notice_js__WEBPACK_IMPORTED_MODULE_2__["showNotice"])("Date was changed to 15 minutes step.");
...
/*!****************************************************!*\
  !*** ./src/script/components/ReadableTimestamp.js ***!
  \****************************************************/
/*! exports provided: is12HourTime, dateFormat, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var is12HourTime = function is12HourTime() {
  return /a(?!\\)/i.test(Object(_wordpress_date__WEBPACK_IMPORTED_MODULE_1__["__experimentalGetSettings"])().formats.time.toLowerCase() // Test only the lower case a
...
var dateFormat = function dateFormat(timestamp) {
  ...
  return Object(_wordpress_date__WEBPACK_IMPORTED_MODULE_1__["date"])(settings.formats.datetime, timestamp);
};

var ReadableTimestamp = function ReadableTimestamp(_ref) {
  var timestamp = _ref.timestamp;
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null, dateFormat(timestamp));
};
  ...
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__["PanelRow"], {
    ...
    renderContent: function renderContent() {
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("div", null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__["DateTimePicker"], {
        ...
        is12Hour: Object(_ReadableTimestamp__WEBPACK_IMPORTED_MODULE_3__["is12HourTime"])(),
...
/* harmony import */ var _hooks_use_post__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./hooks/use-post */ "./src/script/hooks/use-post.js");
...
PostToMailchimp.customConfig = [{
  ...
  Element: function Element(_ref) {
    ...
    var post = Object(_hooks_use_post__WEBPACK_IMPORTED_MODULE_6__["usePost"])();
...
/*!**********************************!*\
  !*** ./src/script/utils/date.js ***!
  \**********************************/
/*! exports provided: isToday, isPastDay, isFutureDate, is15MinutesStep, ceil15Minutes, floor15Minutes, round15Minutes */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var showNotice = function showNotice(message) {
  Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_0__["dispatch"])('core/notices').createNotice(message);
};
